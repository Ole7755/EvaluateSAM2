...
def main() -> None:
    ...
    if args.save_pred_masks:
        pred_output_dir = (
            args.pred_output_dir or _default_pred_dir(args.results_root, spec.dataset, spec.sequence, args.tag)
        ).resolve()
    ...
    for token in frame_tokens:
        ...
        try:
            ...
            print(f"[WARN] 帧 {token} 无法生成提示：{exc}，将使用空预测掩码。")
    ...
    summary["prompt_type"] = args.prompt_type
